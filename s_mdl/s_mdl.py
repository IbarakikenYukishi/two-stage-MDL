...
class retrospective:
    ...
    def __init__(self, h, encoding_func, complexity_func, sigma_0=0.05, sigma_1=0.05, sigma_2=0.05, order=-1):
        """
        Args:
            h: half window size
            encoding_func: encoding function
            complexity_func: parametric complexity of the encoding function
            sigma_0: the upper bound of the Type-I error probability of 0th D-MDL
            sigma_1: the upper bound of the Type-I error probability of 1st D-MDL
            sigma_2: the upper bound of the Type-I error probability of 2nd D-MDL
        ...
        # sigma
        self.__threshold_0 = self.__complexity_func(2 * self.__h) - np.log(sigma_0)
        self.__threshold_1 = 2 * self.__complexity_func(self.__h) - np.log(sigma_1)
        self.__threshold_2 = 2 * \
            (2 * self.__complexity_func(self.__h) - np.log(sigma_2))
        self.__order = order
